...
<body>
    ...
    <?php require_once("../controller/UpdateLivro.php");?>
    <div class="row">
        <form method="post" action="../controller/UpdateLivro.php" id="form" name="form" onsubmit="validar(document.form); return false;" class="col-10">
